...
class ProcessDeduplicator:
    def __init__(self, es_client: Elasticsearch, index_name: str, batch_size: int = 10000):
        self.es = es_client
...
def main():
    ...
    # 创建去重器实例，设置适当的批处理大小
    deduplicator = ProcessDeduplicator(es, index_name, batch_size=10000)
    
    # 执行去重
    deduplicator.deduplicate(new_index_name="processwithghg_dedup2")
